...
public class Ejercicio6 {
    ...
    public static void main(String[] args) {
        ...
        //Ciclo FOR para mostrar el contenido del vector
        ...
        do {
            if (respuesta.equals("SI") || respuesta.equals("S")) {
                ...
                indice=lector.nextInt()-1; //Se puede ingresar un numero del 1 al 10, sin embargo para que coincida
                ...
                lector.nextLine(); //Después de solicitar el entero queda guardado el "enter" en el buffer
                                           //por lo que debe limpiarse el buffer incluyendo una instrucción nextLine
